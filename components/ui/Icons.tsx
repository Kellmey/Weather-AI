...
export const RainIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 16.2c.4.3.8.7 1.1 1.2a4.9 4.9 0 01.3 2.6H2.6a4.9 4.9 0 01.3-2.6c.3-.5.7-.9 1.1-1.2m0 0l2.2-2.2a4 4 0 015.6 0l2.2 2.2m-10 0a5 5 0 019 0m0 0l2.2-2.2a4 4 0 015.6 0l2.2 2.2" />
